...
function LoginManagement() {
  document.title = "DSCE | Management Login";
  ...
  return (
    <>
      ...
      <div className="flex justify-center items-center h-screen bg-gradient-to-r from-cyan-500 from-10% via-purple-400 via-40% to-pink-500 to-100%">
        <form
          className="form-signin flex justify-center items-center flex-col gap-3 backdrop-blur-md bg-white/30 border border-white/20 rounded-lg p-8 shadow shadow-red-400 w-1/3 max-lg:w-2/3 max-md:w-3/4 max-[400px]:w-4/5"
        ...
        >
          ...
          <p className="text-muted text-center text-gray-400">
            © DSCE - College Placement Management System 2025 - 26
          </p>
        </form>
      </div>
    </>
