...
const Sidebar = ({ isSidebarVisible }) => {
  ...
  return (
    <>
      <nav
        className={`bg-[#f2f2f2] w-[240px] min-h-screen h-full z-20 flex flex-col fixed top-0 transition-transform duration-300 ${
          sidebar ? "translate-x-0" : "-translate-x-full"
        } shadow-md navbar-container lg:w-[260px]`}
      >
        ...
        <div className="bottom-0 absolute w-full transition-all duration-300">
          ...
          {dropdownOpen && (
            ...
            >
              ...
              {loadData.role === "student" && (
                <Link
                  to={`../student/account`}
                  className="flex items-center rounded-t-md no-underline text-black p-3 hover:bg-blue-300"
                >
              ...
              <button
                ...
                className="flex items-center rounded-t-md w-full p-3 text-red-700 hover:bg-blue-300"
              >
          ...
          {/* User Profile */}
          <div
            className="flex justify-center items-center cursor-pointer bg-blue-100"
          ...
          >
            <img
              ...
              alt="Profile Img"
              width="45px"
              className="mx-2 my-2 rounded-2xl transition-all duration-300 shadow-md"
            />
