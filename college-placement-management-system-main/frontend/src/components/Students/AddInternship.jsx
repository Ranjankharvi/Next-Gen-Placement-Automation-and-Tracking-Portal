...
function AddInternship() {
  document.title = "DSCE | Add Internships";
  ...
  const fetchInternshipData = async () => {
    try {
      ...
      if (error.response?.data?.msg) {
        ...
        setToastMessage(
          "Error while updating internship please try again later!"
        );
      }
      setShowToast(true);
    } finally {
        ...
        <>
          <div className="my-8 backdrop-blur-md bg-white/30 border border-white/20 rounded-lg shadow shadow-red-400 p-6">
            <div className="grid grid-cols-2 gap-2 max-sm:grid-cols-1">
              ...
              <FloatingLabel
                controlId="floatingInternshipDuration"
                label={
                  <>
                    <span>
              ...
              <FloatingLabel
                controlId="floatingMonthlyStipend"
                label="Monthly Stipend in Rupees"
              >
                <Form.Control
                  type="number"
                  step={500}
