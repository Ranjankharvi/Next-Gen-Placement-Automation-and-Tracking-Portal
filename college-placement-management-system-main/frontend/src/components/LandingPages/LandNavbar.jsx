...
function LandingNavbar() {
  ...
  return (
    <header
      className={`w-full z-50 transition-all duration-300 ease-in-out ${isslcrolled ? 'backdrop-blur-md bg-white/60 shadow-md sticky top-0' : ''
        }`}
    >
