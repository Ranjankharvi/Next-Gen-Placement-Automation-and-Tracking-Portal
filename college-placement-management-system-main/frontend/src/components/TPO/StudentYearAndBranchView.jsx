...
function StudentYearAndBranchView() {
  document.title = "DSCE | All Students";
                ...
                >
                  ...
                  <Accordion.Body>
                    ...
                    >
                      <StudentTable
                        branchName={"Computer"}
                        studentData={fourthYearComputer}
                      />
                      <StudentTable
                        branchName={"Civil"}
                        studentData={fourthYearCivil}
                      />
                      <StudentTable
                        branchName={"ECS"}
                        studentData={fourthYearECS}
                      />
                      <StudentTable
                        branchName={"EEE"}
                        studentData={fourthYearAIDS}
                      />
                      <StudentTable
                        branchName={"Mechanical"}
                        studentData={fourthYearMechanical}
                      />
                    </Accordion>
                  </Accordion.Body>
                </Accordion.Item>
                ...
                >
                  ...
                  <Accordion.Body>
                    ...
                    >
                      <StudentTable
                        branchName={"Computer"}
                        studentData={thirdYearComputer}
                      />
                      <StudentTable
                        branchName={"Civil"}
                        studentData={thirdYearCivil}
                      />
                      <StudentTable
                        branchName={"ECS"}
                        studentData={thirdYearECS}
                      />
                      <StudentTable
                        branchName={"EEE"}
                        studentData={thirdYearAIDS}
                      />
                      <StudentTable
                        branchName={"Mechanical"}
                        studentData={thirdYearMechanical}
                      />
                    </Accordion>
                  </Accordion.Body>
                </Accordion.Item>
                ...
                >
                  ...
                  <Accordion.Body>
                    ...
                    >
                      <StudentTable
                        branchName={"Computer"}
                        studentData={secondYearComputer}
                      />
                      <StudentTable
                        branchName={"Civil"}
                        studentData={secondYearCivil}
                      />
                      <StudentTable
                        branchName={"ECS"}
                        studentData={secondYearECS}
                      />
                      <StudentTable
                        branchName={"EEE"}
                        studentData={secondYearAIDS}
                      />
                      <StudentTable
                        branchName={"Mechanical"}
                        studentData={secondYearMechanical}
                      />
                    </Accordion>
                  </Accordion.Body>
                </Accordion.Item>
                ...
                >
                  ...
                  <Accordion.Body>
                    ...
                    >
                      <StudentTable
                        branchName={"Computer"}
                        studentData={firstYearComputer}
                      />
                      <StudentTable
                        branchName={"Civil"}
                        studentData={firstYearCivil}
                      />
                      <StudentTable
                        branchName={"ECS"}
                        studentData={firstYearECS}
                      />
                      <StudentTable
                        branchName={"EEE"}
                        studentData={firstYearAIDS}
                      />
                      <StudentTable
                        branchName={"Mechanical"}
                        studentData={firstYearMechanical}
                      />
                    </Accordion>
                  </Accordion.Body>
                </Accordion.Item>
