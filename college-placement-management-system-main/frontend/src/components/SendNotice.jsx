...
function SendNotice() {
  document.title = "DSCE | Send Notice";
  ...
  const confirmSubmit = async () => {
    try {
      const response = await axios.post(
        `${BASE_URL}/management/send-notice`,
        data,
        {
  ...
  return (
    <>
            ...
            <div className="my-8 backdrop-blur-md bg-white/30 border border-white/20 rounded-lg shadow shadow-red-400 p-6 max-sm:text-sm max-sm:p-3">
              <div className="grid grid-cols-2 gap-2">
                ...
                <FloatingLabel
                  ...
                  className={
                    currentUser?.role === "tpo_admin" ? "col-span-2" : ""
                  }
                >
                  <Form.Control
                    type="text"
            ...
            <div className="flex flex-col justify-center items-center gap-2">
              <Button
                ...
                onMouseEnter={(e) => {
                  e.target
                    .querySelector("i")
                    .classList.add("fa-solid", "fa-bounce");
                }}
                onMouseLeave={(e) => {
                  e.target
                    .querySelector("i")
                    .classList.remove("fa-solid", "fa-bounce");
                }}
              >
      ...
      <ModalBox
        ...
        close={closeModal}
        header={"Confirmation"}
        body={`Sending Notice ${data?.message ? `"${data?.message}"` : ""} to ${
          data?.receiver_role || "student"
        }?`}
        btn={"Send"}
