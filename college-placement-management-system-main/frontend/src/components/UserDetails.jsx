...
function UserDetails() {
  document.title = "DSCE | Complete Profile";
        ...
        <>
          ...
          <div className="px-4 py-10">
            <h1 className="text-2xl md:text-4xl">
              {userData?.first_name + " "}
              {userData?.middle_name === undefined
                ? ""
                  ...
                  <div className="px-2 py-3 flex flex-col items-center gap-4 my-1">
                    ...
                    >
                      <Form.Control
                        ...
                        required={
                          userData?.profile ===
                            "/profileImgs/default/defaultProfileImg.jpg" &&
                          completeProfileReq
                        }
                        disabled={
                          !completeProfileReq &&
                  ...
                  <div className="backdrop-blur-md bg-white/30 border border-white/20 rounded-lg shadow shadow-red-400 p-6 my-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3">
                      <div className="px-2 py-3 flex flex-col gap-2">
                        <FloatingLabel
                          controlId="floatingSelectsslc"
                          label="10th Board Name"
                        >
                          <Form.Select
                            aria-label="Floating label select sslcBoard"
                            className="cursor-pointer"
                            name="sslcBoard"
                            value={
                          ...
                          >
                            <option
                              ...
                              className="text-gray-400"
                            >
                              Enter Your 10th Board Name
                            </option>
                            <option value=" Karnataka School Examination and Assessment Board (KSEAB)">
                        ...
                        <FloatingLabel
                          controlId="floatingSelectsslcPassingYear"
                      ...
                      <div className="px-2 py-3 flex flex-col gap-2">
                        ...
                        >
                          ...
                          >
                            <option
                              ...
                              className="text-gray-400"
                            >
                              Enter Your 12th Board Name
                            </option>
                            <option value="Department of Pre-University Education, Government of Karnataka">
                        ...
                        <FloatingLabel
                          controlId="floatingSelectPUCPassingYear"
                        ...
                        >
                          ...
                          >
                            <option
                              ...
                              className="text-gray-400"
                            >
                              Enter Your Diploma Specilization
                            </option>
                            <option value="Computer">Computer</option>
                            <option value="Civil">Civil</option>
                            <option value="Mechanical">Mechanical</option>
